...
categories:
- - 后端
cover: https://raw.githubusercontent.com/3309446352/Images/main/img/d7520811f04bda3d61ccac6246ff986eb92f0e9e229c8e820f36608dcc9d78eb.webp
...
![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=f6f8fa.jpeg)
...
任务是在同一个运行器上执行的一组步骤（steps）。一个步骤（steps）要么是一个 shell 脚本（script）要么是一个动作（action）。步骤会顺序执行，并彼此独立。因为每一个步骤都在同一个运行器上被执行，所以你可以从一个步骤（step）传递数据到另一个步骤（step） 。
...
在这个图表，你可以看到你刚创建的工作流文件，以及这些 GitHub Actions 组件是如何组织的。每一个步骤都会执行一个独立的动作或者脚本文件。任务 1 和 2 是运行命令，任务 3 和 任务 4 是运行脚本文件。找到更多预构建的动作，查看 「[查找和自定义动作](https://link.juejin.cn?target=https%3A%2F%2Fdocs.github.com%2Fcn%2Factions%2Flearn-github-actions%2Ffinding-and-customizing-actions "https://docs.github.com/cn/actions/learn-github-actions/finding-and-customizing-actions")」。

![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=f6f8fa-1771175000116-1.jpeg)
...
![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=fafbfb.jpeg)

3. 在左侧 sidebar，点击你想查看的工作流

![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=ffffff.jpeg)

4. 在 `Workflow runs` ，点击你想查看的运行记录的名称：

![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=ffffff-1771175000117-2.jpeg)

5. 在 Jobs 或者在可视化图表中，点击你想看到的任务：

![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=fefefe.jpeg)

6. 查看每一个步骤的结果：

![](https://raw.githubusercontent.com/3309446352/Images/main/Content/&b=272b30.jpeg)
...
[还不会用 GitHub Actions ？看看这篇这篇我翻译整理了 GitHub Actions 的官方文档，为大家介绍 - 掘金](https://juejin.cn/post/7042619884643024903#heading-5)
