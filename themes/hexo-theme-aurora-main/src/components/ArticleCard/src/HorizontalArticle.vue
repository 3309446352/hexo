  ...
  <div>
    ...
    <div class="article-container" @click="handleCardClick(post?.slug)">
      ...
      <div class="feature-article">
        <div class="feature-thumbnail" @mouseenter="showHover = true" @mouseleave="showHover = false">
          <img v-if="ImgList[currentIndex]" class="ob-hz-thumbnail" v-lazy="ImgList[currentIndex]" />
          <img v-else-if="post.cover" class="ob-hz-thumbnail" :alt="`avatar-${post.author.name}`" v-lazy="post.cover" />
          <img v-else class="ob-hz-thumbnail" src="../../../assets/default-cover.webp" alt="" />
        ...
        <div class="feature-content">
          <span>
            <b v-if="post.pinned" class="article-tag">
              <span>
                <SvgIcon icon-class="hot" width="1.05rem" height="1.05rem" class="-mb-0.5 mr-1" stroke="currentColor" />
          ...
          <span class="flex flex-wrap">
            <ul>
              <template v-if="post.tags && post.tags.length > 0">
                <li v-for="index in numberOfTags" :key="post.tags[index - 1].slug"
          ...
          <div class="article-footer" v-if="post.count_time">
            <div class="flex flex-row items-center">
              <img :class="avatarClass" v-lazy="post.author.avatar" :alt="`avatar-${post.author.name}`"
    ...
    <div class="feature-article-nav" v-if="isVisible">
      ...
      <div class="carousel-indicators">
        <span v-for="(item, index) in ImgList" :key="index" :class="{ active: currentIndex === index }"
