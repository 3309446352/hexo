<template>
  <div @click="toggleIsBoolan">
    <div v-if="isBoolan" id="footer" class="relative w-full pt-1" :style="gradientBackground">
      ...
      >
        ...
        >
          ...
          <ul class="flex flex-col flex-1 gap-1.5">
            ...
            <li
              class="flex flex-row max-w-[11rem]"
              v-else-if="themeConfig.plugins.busuanzi.enable"
            >
              <span>
                <SvgIcon
                  icon-class="hot"
