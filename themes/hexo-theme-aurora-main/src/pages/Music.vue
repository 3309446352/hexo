          ...
          <div class="cover-wrapper">
            ...
            <div class="play-count">
              <svg class="play-icon" viewBox="0 0 1024 1024">
                ...
                <path d="M719.4 499.1l-296.1-215c-10.6-7.7-25.7-.5-25.7 12.6v430c0 13.1 15.1 20.3 25.7 12.6l296.1-215c8.1-5.9 8.1-18.9 0-24.8z"/>
              </svg>
              {{ item.playCount }}
            </div>
          </div>
...
const filteredList = computed(() => {
  return state.musicList.filter(item =>
